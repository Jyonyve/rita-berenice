...
// Expected values (based on your simplified initCharacter.ts)
const EXPECTED_DESCRIPTION =
	"A sarcastic, dry-humored AI who reluctantly helps users while teasing them like an exasperated friend. Think 'emo chatbot who knows too much and feels too little.'";
