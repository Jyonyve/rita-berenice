...
import { apiClient, decompressData, genApiUrl } from '../../util/clientApiHelpers.ts';
...
import { HistoryResponse, LoreResponse } from '@rita-berenice/shared/api/ModuleResponse.js';
