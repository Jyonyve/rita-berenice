      ...
      >
        <Container maxWidth="md">
          ...
          <GlassBox sx={{ p: { xs: 2, md: 4 } }}>
            ...
            <Typography variant="body2" sx={{ fontFamily: 'Ipanema Secco', fontStyle: 'italic', lineHeight: 1.7 }}>
              “Now if there is no resurrection, what will those do who are baptized for the dead? If the dead are not
              raised at all, why are people baptized for them? And as for us, why do we endanger ourselves every hour? I
              face death every day—yes, just as surely as I boast about you in Christ Jesus our Lord.”
            </Typography>
          </GlassBox>
        </Container>
      </GlassPaper>
