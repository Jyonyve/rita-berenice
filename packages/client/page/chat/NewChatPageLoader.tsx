...
import { useCharacterApi, useProfileApi, useSessionApi, useTempChatApi } from '../../hook/api/index.js';
...
import { ProfileCdo, ChatMessage, TempChatTurn, SessionContentPolicy } from '@rita-berenice/shared/domain';
...
export function NewChatPageLoader() {
  ...
  return (
    <Box display="flex" flexDirection="column" alignItems="center" justifyContent="center" sx={{ height: '80vh' }}>
      {error ? (
