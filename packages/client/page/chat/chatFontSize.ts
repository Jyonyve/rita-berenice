...
export const getChatFontSizeStorageKey = (userId: string): string =>
	`rita-chat-font-size:${userId}`;

export const getChatFontWeightStorageKey = (userId: string): string =>
	`rita-chat-font-weight:${userId}`;
...
export const readChatFontWeight = (
	storage: Pick<Storage, 'getItem'> | undefined,
	key: string
): ChatFontWeight => {
	try {
