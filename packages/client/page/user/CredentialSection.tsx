  ...
  return (
    <GlassCard variant="elevation">
      <Alert severity="info" sx={{ mb: 2, fontSize: '0.875rem' }}>
        {getLangText(LANG_KEYS.API_KEYS_DESCRIPTION)} Saved values are never shown; enter a value only to add or replace
        a key.
      </Alert>
              ...
              <Controller
                ...
                render={({ field }) => (
                  <TextField
                    ...
                    helperText={configured ? 'Configured. Enter a new value to replace it.' : 'Not configured.'}
                    slotProps={{
                      input: {
                        endAdornment: (
      ...
      <Box display="flex" justifyContent="flex-end" mt={2}>
        <GlassButton onClick={save} colorVariant="secondary" disabled={isSubmitting} loading={isSubmitting}>
