...
import { GlassButton, GlassCard, GlassPaper, GlassPortraitSlider } from '../../layout/component/glass/index.js';
...
import { CharacterLoreHistoryTabs } from './ProfileHistoryTab.jsx';
...
const CharacterPage: FC<{
  ...
  const handleStartNewSession = async (profileCdo: ProfileCdo, contentPolicy: SessionContentPolicy = 'general') => {
      ...
      <Grid container spacing={containerSpacing}>
        ...
        <Grid
          ...
          sx={{
            ...
            height: {
              xs: 'auto',
              md: (theme) => `calc(100vh - var(--header-height) - var(--footer-height) - ${theme.spacing(8)})`,
            },
            display: 'flex',
          ...
          <Box display="flex" flexDirection="column" gap={2}>
                  ...
                  {isLoggedIn && isMine && (
                    <Tooltip title={getLangText(LANG_KEYS.EDIT_CHARACTER)}>
                      <IconButton
                        ...
                        aria-label={getLangText(LANG_KEYS.EDIT_CHARACTER)}
                        size="small"
            ...
            {isLoggedIn && (
              <>
                ...
                {/* Profile Card */}
                <CharacterLoreHistoryTabs characterId={characterId} onHistory={handleHistory} />
                <GlassCard variant="outlined">
                  <ProfileForm userId={userId} onSubmit={handleStartNewSession} mode="create" showTemplateSelector />
                </GlassCard>
              </>
            )}
          </Box>
