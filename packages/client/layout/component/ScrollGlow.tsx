 ...
 */
export const ScrollGlow: FC<ScrollGlowProps> = ({ showTop, showBottom, isScrolling, shouldUseMobileLayout }) => {
    ...
    <Box
      sx={{
        ...
        '&::before': {
          ...
          top: `-${glowOffset}`,
          background: `linear-gradient(to bottom, ${solidBackgroundColor} 50%, ${alpha(
        ...
        '&::after': {
          ...
          bottom: `-${glowOffset}`,
          background: `linear-gradient(to top, ${solidBackgroundColor} 50%, ${alpha(
            theme.palette.primary.light,
            0.3,
          )} 90%, transparent 100%)`,
