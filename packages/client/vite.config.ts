...
export default defineConfig(({ mode, isSsrBuild }) => {
  ...
  return {
    ...
    define: {
      'import.meta.env.VITE_API_DOMAIN': JSON.stringify(env.VITE_API_DOMAIN || 'http://localhost:3000'),
      'import.meta.env.VITE_APP_DOMAIN': JSON.stringify(env.VITE_APP_DOMAIN || 'http://localhost:3000'),
