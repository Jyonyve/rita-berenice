...
import { DEFAULT_CHARACTER_VISIBILITY, DEFAULT_LOCALIZE_DIRECTIONS, NA } from '../config/constants.js';
import { DEFAULT_EMOTION } from '../config/emotionConstants.js';
import { DEFAULT_USER_AVATAR } from '../config/imageConstants.js';

//type guard
export const isLoreRetrievalEnabled = (lore: Pick<LoreInfo, 'retrievalEnabled'>): boolean =>
  lore.retrievalEnabled === true;

export function isCharacterTermInfo(term: CharacterTermCdo | CharacterTermInfo): term is CharacterTermInfo {
...
export function isCharacterInfo(character: CharacterCdo | CharacterInfo): character is CharacterInfo {
