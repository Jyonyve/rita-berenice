...
import { ChatEntry, ChatRoleType, ChatMessage, ChatMessageType } from '@rita-berenice/shared/domain';
...
export const parseConversationToEntries = (text: string): ChatEntry[] => parseChatEntries(text, 'quoted-dialogue');
