import { VectorSearchResponse } from '@rita-berenice/shared/api';
...
export const runRagEvaluation = (evaluationCase: RagEvaluationCase): RagEvaluationResult => {
  const ranked = reRankSemanticResults(evaluationCase.queryResults, evaluationCase.k, evaluationCase.rankingOptions);
