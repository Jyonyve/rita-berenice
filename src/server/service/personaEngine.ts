...
import {
	...
	parseEntriesToText,
	DEFAULT_CHAT_MODEL, // Assuming you have a default chat model defined
...
const PERSONA_RESPONSE_MODEL: AiModelInfo = DEFAULT_CHAT_MODEL;
...
export const personaEngine = {
	...
	async generateResponse(
		...
		characterInfo: CharacterMetadata,
		...
		try {
			...
			const [factualRecap, relationshipRecap, lore] = await Promise.all([
				...
				loreService.getLoreForCharacter(characterId), // Gets the absolute "ground truth" for the character
			]);
