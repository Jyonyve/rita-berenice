...
The app combines a Vite React client, an Express SSR/API server, shared domain contracts, and development-only migration scripts for Chroma-backed character, chat, lore, history, recap, and credential data.
...
- `packages/migration`: development-only data migration and maintenance scripts.
